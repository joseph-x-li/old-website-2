...
### Human Languages
 ...
 <img src="/blog/2021_duolingo.png" style="display: block; margin-left: auto; margin-right: auto; width: 40%">
...
### Computer Languages
 - `C`: Not much happened here, except in compilers where I implemented a Cilk-like runtime for C0 and encountered errors I never knew were possible. We all know `SIGSEGV`, but have you seen `SIGBUS`? Somehow, we also got `SIGILL` when doing `-fPIE` stuff.
